                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="tb_ticket_number"
                                value="{{ \Carbon\Carbon::now()->format('Ymd') }}{{ $jobcardId }}">
                            <input type="hidden" name="tb_id" value="{{ $jobcardId }}">
                            <small id="tb_ticket_number_help" class="form-text text-muted">Ticket number auto generated and
                                ...
                                <div class="col-6">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="installation">
                                            installation
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="preventive maintenance">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="corrective maintenance">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="upgrade">
                                            upgrade
                                        </label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check">
                                        <labelclass="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="force majeure">
                                            force majeure
                                            </labelclass=>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="development">
                                            development
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="training">
                                            training
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="cb_service_type[]"
                                                id="cb_service_type" value="other">
                                            other
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="datetime-local" name="dt_complete_time"
                                id="dt_complete_time">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label for="cbx_sparepart" class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="cbx_sparepart" id="cbx_sparepart"
                                        value="true">
                        ...
                        <a class="btn btn-outline-danger" href="{{ route('jobcard.cancelTicket', ['id' => $jobcardId]) }}"
