    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i
                            class="fas fa-bars"></i>&nbsp; Show/Hide</a>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <span class="brand-link">
                <img src="{{ asset('template/dist/img/yaksa/Logo.png') }}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('template/dist/img/160x160.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('jobcard.index') }}" class="nav-link">
                                {{-- <i class="nav-icon fas fa-home"></i> --}}
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <a href="#">Yaksa harmoni global</a>.</strong> All rights reserved. Powered by
            AdminLTE
        </footer>
