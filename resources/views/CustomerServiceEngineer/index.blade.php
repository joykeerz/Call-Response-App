                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input required type="text" name="tb_cse_name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Initial</label>
                            <input required type="text" name="tb_cse_initial" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Area</label>
                            <input required type="text" name="tb_cse_area" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>No. HP</label>
                            <input required type="text" name="tb_cse_hp" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select required class="form-control select2" style="width: 100%;" name="cb_sp" id="cb_sp">
                                @forelse ($sps as $sp)
                ...
                <tbody>
                    @forelse ($cse as $cser)
                        <tr>
                            ...
                            <td>
                                <button onclick="edit('{{ $cser->cseid }}')" class="btn btn-success float-right mr-2"><i
                                        class="fa fa-pencil-alt"></i></button>
                                <a onclick="return  confirm('are you sure?')" class="btn btn-danger float-right mr-2"
                                    href="{{ route('cse.delete', ['id' => $cser->cseid]) }}"><i class="fa fa-trash"
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#cbSp').append(
                        `<option selected value="${response['sp_id']}">current : ${response['sp_company_name']}</option>`
                    );
