...
@section('header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Main Jobcard Dashboard</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                    <li class="breadcrumb-item active">Jobcard Dashboard</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
@section('title')
    Yaksa Harmoni Global | Jobcard Dashboard
@endsection
                ...
                <tbody>
                    @forelse ($jobcards as $jobcard)
                        <tr>
                            ...
                            <td><a onclick="return confirm('see details ?')"
                                    class="btn btn-outline-secondary float-right mr-2"
                                    href="{{ route('jobcard.jobcardDetail', ['id' => $jobcard->id]) }}"><i
