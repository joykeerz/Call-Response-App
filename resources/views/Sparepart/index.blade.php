            ...
            <form action="{{ route('spp.store') }}" method="post">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Module</label>
                            <input required type="text" name="tb_part_module" class="form-control">
                        </div>
                        <div class="form-group">
                  ...
                  <input required type="date" name="tb_date_out" class="form-control">
                        ...
                        <div class="form-group">
                            <label>Product</label>
                            <select required class="form-control select2" style="width: 100%;" name="cb_product"
                                id="cb_product">
                        ...
                        <form id="form-update" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input required type="text" id="tbPartNumber" name="tbPartNumber"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input required type="text" id="tbSerialNumber" name="tbSerialNumber"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <label>Module</label>
                                    <input required type="text" name="tbPartModule" id="tbPartModule"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <select required class="form-control select2" style="width: 100%;" name="cbProduct"
                                        id="cbProduct">
                                        @forelse ($products as $product)
                                            <option value="{{ $product->id }}">{{ $product->product_name }} |
                                                {{ $product->brand_name }} | {{ $product->type_series }}</option>
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#tbPartModule').val(response['part_module']);
                    $('#cbCondition').append(
                        `<option selected value="${response['part_condition']}">current : ${response['part_condition']}</option>`
                    );
                    $('#cbProduct').append(
